...
# from utils import ordinal_cols, nominal_cols, binary_cols, ordinal_categories
...
def extract_lr_coefficients(final_model, label_encoder, numerical_cols, model, plots_dir=None):
    ...
    if plots_dir:
        ...
        coef_df.to_csv(os.path.join(plots_dir, f"{model}_coefficients_unscalednumericalfeatures.csv"),index=False)
